...
<div style="text-align: center;">
  <img src="/assets/images/projects/electrical-stimulation/e-stimv3-pics/top.jpg" alt="Electrical Stimulation" width="600">
</div>
...
I won't spend too much time going into V2 buecause V3 will cover most of the same ground, but with some key improvements. The biggest one being the inclusion of a USB-C connector for power and data, as well as a more robust power supply design and improve stimulator frontend. 

## V3
Here's the V3 board block diagram:
...
Unfortunately I can't share the schematic or board layout for this project due to the sensitive nature of the research it's intended for, but I will talk about some of the design decisions and challenges involved in the design of this board.

### Analog Front End
The analog front end is the part of the board that interfaces with the outside world. It's responsible for generating the electrical stimulation signals that interact will cells. In the V2 design, the analog front end suffered from excessive noise coupling from the on-board switching power supplies as well as from a 60 Hz noise which was picked up from the ambient environment. 



### Power Supply
The power supply is a bit more complex than your average USB powered device. 
